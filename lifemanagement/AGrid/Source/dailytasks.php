...
function BuildTable($db,$tbl,$pos=1,$sortcol='',$sortdesc=0)
{
  ...
  $result = mysql_query("SELECT id, name, type, description, priority, duedate, actionable, nextaction, project, status FROM $tbl where type = 'Daily' and memberid = '{$user}'  ORDER BY duedate ASC LIMIT $possql,$pospage");
